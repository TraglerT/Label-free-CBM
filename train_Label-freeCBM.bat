...
set extraSettings=--batch_size 512 --print --print --n_iters 5 --clip_cutoff 0.26 --interpretability_cutoff %interpretability_cutoff% --lam 0.002 --n_iters_interpretability_cutoff %n_iters_interpretability_cutoff%
